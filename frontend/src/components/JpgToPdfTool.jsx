...
export default function JpgToPdfTool({ isDark }) {
  ...
  return (
    <div>
      <h2 style={{fontSize:22,fontWeight:800, boxShadow:'0 4px 14px rgba(124,58,237,0.35)',marginBottom:16,color:titleColor}}>JPG para PDF</h2>
      ...
      <button onClick={handleConvert} disabled={loading||!files.length} style={{marginTop:16,background:PURPLE,color:'#fff',border:0,padding:'14px 24px',borderRadius:12,fontWeight:800, boxShadow:'0 4px 14px rgba(124,58,237,0.35)',cursor:'pointer',width:'100%',opacity:loading||!files.length?0.6:1}}>

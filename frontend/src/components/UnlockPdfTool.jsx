...
export default function UnlockTool({ isDark }) {
  ...
  return (
    <div>
      ...
      <button onClick={handleUnlock} disabled={loading || !file} style={{ marginTop: 16, background: '#5B21B6', color: '#fff', border: 0, padding: '16px 26px', borderRadius: 10, fontWeight: 800, cursor: 'pointer', width: '100%', opacity: loading || !file ? 0.35 : 1 }}>
